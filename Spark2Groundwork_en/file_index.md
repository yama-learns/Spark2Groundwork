...
> **Using the index in place of checking is failure family ①.**
...
| All working rules (R-01–R-32) | `governance/RULES.md` |
| Failure families ①–⑦ | `governance/Incident_Log.md` §2 |
...
| `sensor_scope_and_t0.py` | T0 uniqueness, write-scope violations |
